...
function familyMain() {
    ...
    family2.processFamilyData = function() {
        $.ajax({
            ...
            success: function(gsaDataCSV) {
                ...
                family2.familyData = localFamilyData;
                ...
                family2.treeFamilyData = newParents;
                updateTree();
            }
        });
    ...
    function updateTreeWithSelectedClass(person, personObj, treeObj, selectedClass) {
        ...
        if (person) {
            ...
            for (var j in family2.treeFamilyData) {
                ...
                {
                    newParents = [family2.treeFamilyData[j]];
                    break;
                }
            }
        }
    ...
    family2.refreshTreeWIthSelectedPerson = function(familyData, familyRefresh) {
