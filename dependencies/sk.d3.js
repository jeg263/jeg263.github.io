    ...
    sk.createSankey = function(containerId, configSankey, dataSankey) {
        ...
        var link = svg.append("g").selectAll(".sk-link")
            ...
            .style("display", function (l) {
                if (configSankey && configSankey.emptyNodes && $.inArray(l.target.id, configSankey.emptyNodes) !== -1) {
                    return "none";
                }
                else {
                    return "block";
        ...
        var node = svg.append("g").selectAll(".sk-node")
            ...
            .style("display", function (n) {
                if (configSankey && configSankey.emptyNodes && $.inArray(n.id, configSankey.emptyNodes) !== -1) {
                    return "none";
                }
                else {
                    return "block";
