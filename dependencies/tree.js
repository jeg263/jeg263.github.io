    ...
    var TreeBuilder = (function () {
        ...
        _createClass(TreeBuilder, [{
            ...
            value: function _update(source) {
                ...
                allNodesGlobal = this.allNodes;
                var beforeElbow = this.svg.selectAll('.link').data(links).enter()
                ...
                this._linkSiblings();
//                        beforeElbow.append('path').attr('class', opts.styles.linage).attr('d', this._elbow);
            ...
            value: function _elbow(d, i) {
                ...
                if (allNodesGlobal) {
                    var allNodes = allNodesGlobal;
                    var mid = allNodes.filter(function (v) {
                        return v.data.id == d.source.data.id - 1;
                    });
            ...
            value: function _linkSiblings() {
                ...
                _.forEach(this.siblings, function (d) {
                    ...
                    var mid = allNodes.filter(function (v) {
                        return d.source.id + 1 == v.data.id;
                    });
                    var end = allNodes.filter(function (v) {
                        return d.target.id == v.data.id;
                    });

                    mid[0].x = start[0].x + start[0].cHeight;
                    end[0].x = start[0].x + start[0].cHeight + 10;

                    // mid[0].x = start[0].x + start[0].cHeight + 5;
                    // end[0].x = start[0].x + start[0].cHeight + 10;
